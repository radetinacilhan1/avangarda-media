...
const copy: Record<Lang, ImpressumCopy> = {
  sr: {
    ...
    details: [
      ...
      { label: "Sediste izdavaca", value: "Mirka Milojkovica 34, sprat 1, Beograd - Palilula" },
  ...
  en: {
    ...
    details: [
      ...
      { label: "Publisher seat", value: "Mirka Milojkovica 34, floor 1, Belgrade - Palilula" },
  ...
  de: {
    ...
    details: [
      ...
      { label: "Sitz des Herausgebers", value: "Mirka Milojkovica 34, 1. Stock, Belgrad - Palilula" },
  ...
  fr: {
    ...
    details: [
      ...
      { label: "Siege de l'editeur", value: "Mirka Milojkovica 34, 1er etage, Belgrade - Palilula" },
  ...
  tr: {
    ...
    details: [
      ...
      { label: "Yayinci merkezi", value: "Mirka Milojkovica 34, 1. kat, Belgrad - Palilula" },
