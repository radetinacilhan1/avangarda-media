...
export const fallbackSignals: FallbackSignal[] = [
  {
    ...
    title_tr: "Gencler ulkeden ayrilmak istiyor",
    title_fr: "Les jeunes veulent quitter le pays",
    title_de: "Junge Menschen wollen das Land verlassen",
    value: "70%",
    value_en: "70%",
    value_tr: "70%",
    value_fr: "70%",
    ...
    description_tr: "Sinyal sadece gitme isteginde degil; sistemin bagli kalmaya degecek bir plan sunmadigi duygusunda.",
    description_fr: "Le signal n'est pas seulement dans le desir de partir, mais dans l'impression que le systeme n'offre aucun projet auquel rester fidele.",
    description_de: "Das Signal liegt nicht nur im Wunsch zu gehen, sondern im Gefuehl, dass das System keinen Plan bietet, dem es sich zu bleiben lohnt.",
    source: "Balkan Barometer",
    source_en: "Balkan Barometer",
    source_tr: "Balkan Barometer",
    source_fr: "Balkan Barometer",
    source_de: "Balkan Barometer",
    sourceUrl: "https://www.rcc.int/balkanbarometer/",
    date: "2025-06-24",
    region: "Srbija / Balkan",
    region_en: "Serbia / Balkans",
    region_tr: "Sirbistan / Balkanlar",
    region_fr: "Serbie / Balkans",
    region_de: "Serbien / Balkan",
    topicLabel: "Demokratija i društvo",
    topicLabel_en: "Democracy and society",
    topicLabel_tr: "Demokrasi ve toplum",
    topicLabel_fr: "Democratie et societe",
    topicLabel_de: "Demokratie und Gesellschaft",
  ...
  },
  {
    ...
    title_tr: "Calisanlar sozlesmesiz calisiyor",
    title_fr: "Des travailleurs travaillent sans contrat",
    title_de: "Arbeitende arbeiten ohne Vertrag",
    value: "1 od 3",
    value_en: "1 in 3",
    value_tr: "3'te 1",
    value_fr: "1 sur 3",
    ...
    description_tr: "Emek kagit uzerinde gorunmez oldugunda, sorun icin kamusal bir dil olusmadan once pazarlik gucu kaybolur.",
    description_fr: "Quand le travail devient invisible sur le papier, le pouvoir de negociation disparait avant meme qu'un langage public pour le probleme ne se forme.",
    description_de: "Wenn Arbeit auf dem Papier unsichtbar wird, verschwindet die Verhandlungsmacht noch bevor sich ueberhaupt eine oeffentliche Sprache fuer das Problem bildet.",
    source: "ILO procene za region",
    source_en: "ILO regional estimates",
    source_tr: "ILO bolgesel tahminleri",
    source_fr: "Estimations regionales de l'OIT",
    ...
    region_fr: "Balkans occidentaux",
    region_de: "Westbalkan",
    topicLabel: "Radnička prava",
    topicLabel_en: "Labour rights",
    topicLabel_tr: "Emek haklari",
    topicLabel_fr: "Droits du travail",
    topicLabel_de: "Arbeitsrechte",
    relatedSection: "analysis",
  ...
  },
  {
    ...
    title_tr: "Yurttaslar onerilen sinirin ustunde hava soluyor",
    title_fr: "Des habitants respirent un air au-dessus de la limite recommandee",
    title_de: "Menschen atmen Luft ueber dem empfohlenen Grenzwert",
    value: "8 od 10",
    value_en: "8 in 10",
    value_tr: "10'da 8",
    value_fr: "8 sur 10",
    ...
    description_tr: "Sorun artik mevsimsel bir epizot degil; kirlilik gunluk hayatin normallestirilmis maliyetine donusuyor.",
    description_fr: "Le probleme n'est plus un episode saisonnier mais un schema: la pollution devient un cout normalise de la vie quotidienne.",
    description_de: "Das Problem ist nicht mehr nur eine saisonale Episode, sondern ein Muster: Verschmutzung wird zu einem normalisierten Preis des Alltags.",
    source: "WHO / lokalna merenja",
    source_en: "WHO / local monitoring",
    source_tr: "WHO / yerel olcumler",
    source_fr: "OMS / mesures locales",
    ...
    region_fr: "Sud de la Serbie",
    region_de: "Suedserbien",
    topicLabel: "Ekologija",
    topicLabel_en: "Ecology",
    topicLabel_tr: "Ekoloji",
    topicLabel_fr: "Ecologie",
    topicLabel_de: "Oekologie",
    relatedSection: "analysis",
  ...
  },
  {
    ...
    title_tr: "Gazetecilere yonelik bildirilen saldirilar artiyor",
    title_fr: "Les attaques signalees contre les journalistes augmentent",
    title_de: "Gemeldete Angriffe auf Journalistinnen und Journalisten nehmen zu",
    value: "+27%",
    value_en: "+27%",
    value_tr: "+27%",
    value_fr: "+27%",
    ...
    description_tr: "Kamusal alan onu belgeleyenler icin riskli hale geldiginde, basin ozgurlugu soyut bir endeks olmaktan cikar ve hayatta kalma meselesine donusur.",
    description_fr: "Quand l'espace public devient risqué pour celles et ceux qui le documentent, la liberte de la presse cesse d'etre un indice abstrait et devient une question de survie.",
    description_de: "Wenn der oeffentliche Raum fuer jene riskant wird, die ihn dokumentieren, hoert Pressefreiheit auf, ein abstrakter Index zu sein, und wird zu einer Ueberlebensfrage.",
    source: "Reporters Without Borders",
    source_en: "Reporters Without Borders",
    source_tr: "Reporters Without Borders",
    source_fr: "Reporters sans frontieres",
    source_de: "Reporter ohne Grenzen",
    sourceUrl: "https://rsf.org/",
    date: "2025-10-18",
    region: "Jugoistočna Evropa",
    region_en: "South-East Europe",
    region_tr: "Guneydogu Avrupa",
    region_fr: "Europe du Sud-Est",
    region_de: "Suedosteuropa",
    topicLabel: "Sloboda medija",
    topicLabel_en: "Media freedom",
    topicLabel_tr: "Medya ozgurlugu",
    topicLabel_fr: "Liberte de la presse",
    topicLabel_de: "Medienfreiheit",
    relatedSection: "analysis",
  ...
  },
  {
    ...
    title_tr: "Insanlar kronik tukendiklerini bildiriyor",
    title_fr: "Des personnes signalent une exhaustion chronique",
    title_de: "Menschen berichten von chronischer Erschoepfung",
    value: "62%",
    value_en: "62%",
    value_tr: "62%",
    value_fr: "62%",
    ...
    description_tr: "Yorgunluk esit dagilmiyor; en cok, gunu guvencesiz calisma, bakim yukumlulugu ve surekli erisilebilirlikten olusanlar tasiyor.",
    description_fr: "L'epuisement n'est pas reparti de facon egale: il pese le plus sur celles et ceux dont la journee depend deja d'un travail precaire, du care et d'une disponibilite constante.",
    description_de: "Erschoepfung verteilt sich nicht gleichmaessig: Sie lastet am staerksten auf jenen, deren Alltag bereits von unsicherer Arbeit, Sorgearbeit und staendiger Erreichbarkeit abhaengt.",
    source: "UNDP / regional survey synthesis",
    source_en: "UNDP / regional survey synthesis",
    source_tr: "UNDP / bolgesel anket sentezi",
    source_fr: "PNUD / synthese regionale d'enquetes",
    ...
    region_fr: "Balkans urbains",
    region_de: "Staedtischer Balkan",
    topicLabel: "Psihologija i društvo",
    topicLabel_en: "Psychology and society",
    topicLabel_tr: "Psikoloji ve toplum",
    topicLabel_fr: "Psychologie et societe",
    topicLabel_de: "Psychologie und Gesellschaft",
    relatedSection: "analysis",
    relatedAnalysisSlug: "umor-kao-javna-tema-ne-privatna-slabost",
    isFeatured: false,
    showOnHomepage: false,
  ...
  },
  {
    ...
    title_tr: "Enerji yoksullugu riski altindaki haneler",
    title_fr: "Menages exposes au risque de pauvrete energetique",
    title_de: "Haushalte mit Risiko von Energiearmut",
    value: "41%",
    value_en: "41%",
    value_tr: "41%",
    value_fr: "41%",
    ...
    description_tr: "Enerji faturasi burada sadece bir maliyet degil; ozel guvenligin daha genis siyasi kararlara ne kadar bagli oldugunun gostergesi.",
    description_fr: "La facture d'energie n'est pas seulement un cout ici, mais un indicateur de la facon dont la securite privee depend de decisions politiques plus larges.",
    description_de: "Die Energierechnung ist hier nicht nur ein Kostenpunkt, sondern ein Indikator dafuer, wie eng private Sicherheit mit groesseren politischen Entscheidungen verknuepft ist.",
    source: "Eurostat / lokalni proračuni",
    source_en: "Eurostat / local calculations",
    source_tr: "Eurostat / yerel hesaplamalar",
    source_fr: "Eurostat / calculs locaux",
    ...
    region_fr: "Europe / Balkans",
    region_de: "Europa / Balkan",
    topicLabel: "Sistem i novac",
    topicLabel_en: "Systems and money",
    topicLabel_tr: "Sistem ve para",
    topicLabel_fr: "Systeme et argent",
    topicLabel_de: "System und Geld",
    relatedSection: "analysis",
