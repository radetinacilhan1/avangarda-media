...
const humanRightsCopyByLang: CopyRecord = {
  sr: {
    ...
    openSourceLabel: "Otvori zvanični izvor",
  ...
  en: {
    ...
    openSourceLabel: "Open official source",
  ...
  tr: {
    ...
    openSourceLabel: "Resmî kaynağı aç",
  ...
  fr: {
    ...
    openSourceLabel: "Ouvrir la source officielle",
  ...
  de: {
    ...
    openSourceLabel: "Offizielle Quelle öffnen",
  ...
  es: {
    ...
    openSourceLabel: "Abrir la fuente oficial",
  ...
  ar: {
    ...
    openSourceLabel: "افتح المصدر الرسمي",
