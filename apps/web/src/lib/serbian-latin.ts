...
const wordReplacements: Array<[string, string]> = [
  ...
  ["tehnicki", "tehnički"],
  ["analiticki", "analitički"],
  ["analiticka", "analitička"],
  ["analiticke", "analitičke"],
  ["izricito", "izričito"],
  ...
  ["izdrzimo", "izdržimo"],
  ["citaoci", "čitaoci"],
  ["korisnicke", "korisničke"],
  ["korisnicki", "korisnički"],
  ["korisnickih", "korisničkih"],
